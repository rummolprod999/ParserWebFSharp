        ...
        let res =
            builder {
                ...
                wait.Until (fun dr ->
                    dr
                        .FindElement(
                            By.XPath("//small[. = ' Информация о тендере']")
                        )
                        .Displayed)
                |> ignore
                ...
                match updated with
                | true -> incr TenderMagnitStroy.tenderUpCount
                | false -> incr TenderMagnitStroy.tenderCount
                ...
                let! delivTerm =
                    body.findElementWithoutExceptionOptional (
                        "//h4[. = 'Описание тендера:']/following-sibling::div[1]",
                ...
                let attachments =
                    body.findElementsWithoutException (
                        "//a[starts-with(@href, '/projects-jb/latest-projects-jb/project.download')]"
                    )
