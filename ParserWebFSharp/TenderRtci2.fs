    ...
    override this.Parsing() =
        ...
        let res =
                   builder {
                                ...
                                let selectTend =
                                    sprintf 
                                        "SELECT id_tender FROM %stender WHERE purchase_number = @purchase_number AND  doc_publish_date = @doc_publish_date AND type_fz = @type_fz" 
                                        stn.Prefix
                                ...
                                let orgName = tn.CusName.HtmlDecode()
                                let IdOrg = ref 0
                                if orgName <> "" then
                                ...
                                let cusName = tn.CusName.HtmlDecode()
                                if cusName <> "" then
                                    let selectCustomer =
