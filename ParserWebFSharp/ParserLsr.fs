...
type ParserLsr(stn: Settings.T) =
    ...
    member private this.ParserSelen(dr: ChromeDriver) =
        ...
        wait.Until (fun dr ->
            dr
                .FindElement(
                    By.XPath("//table[@id = 'grid_TenderGridViewModel']/tbody/tr/td[8]")
                )
                .Displayed)
        |> ignore
        ...
        let tenders =
            dr.FindElementsByXPath("//table[@id = 'grid_TenderGridViewModel']/tbody/tr")
        ...
        for i in 1..5 do
            ...
            let btn =
                dr.FindElement(By.XPath("//li[@class = 'next']/a[@href = '#']"))
        ...
        for t in listTenders do
            try
                t.Parsing()
            with
                | ex -> Logging.Log.logger (ex, t.etpUrl)

        ()

    member private this.ParserTender(el: IWebElement) =
        let hrefT =
            el.FindElement(By.XPath("./td[2]/a"))
        ...
        let hrefL =
            el.FindElement(By.XPath("./td[1]/a"))
