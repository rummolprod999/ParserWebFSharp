...
type TenderTGuru(stn: Settings.T, tn: TGuruRec, typeFz: int, etpName: string, etpUrl: string) =
    ...
    override this.Parsing() =
        ...
        if reader.HasRows then
            ...
            match updated with
            | true -> incr TenderTGuru.tenderUpCount
            | false -> incr TenderTGuru.tenderCount
            ...
            cmd12.Parameters.AddWithValue("@currency", "рублей")
            |> ignore
