...
type ParserMetodholding(stn: Settings.T) =
    ...
    member private __.ParsingPage(url: string) =
        ...
        | s ->
            ...
            let tens =
                documents
                    .QuerySelectorAll("td > a[onclick^='send(this,']")
                    .ToList()
    ...
    member private __.ParsingOrg org section url =
        ...
        let Page =
            Download.DownloadPost(parametrs, url)
    ...
    member private __.ParsingTender (t: IElement) (url: string) (section: string) =
        ...
        let res =
            builder {
                ...
                let! attr =
                    t.GsnAtrDocWithError "td:nth-child(2) > a" "onclick"
                    <| sprintf "attr not found %s %s " url (t.TextContent)
                ...
                if attr1 = "" || attr2 = "" then
                    return! Err "attrs not found"

                let! datePubT =
                    t.GsnDocWithError "td:nth-child(3)"
                ...
                let T =
                    TenderMetodholding(set, tend, 270, "ПМХ", "http://metholding.com/")
