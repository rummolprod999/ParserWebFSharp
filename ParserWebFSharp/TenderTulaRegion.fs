...
type TenderTulaRegion
    ...
    override this.Parsing() =
        ...
        if driver.Url = "https://zakupki.yarregion.ru/purchasesoflowvolume-asp/" then
            failwith "start page"
