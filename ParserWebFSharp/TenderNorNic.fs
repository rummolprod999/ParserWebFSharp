        ...
        if reader.HasRows then reader.Close()
            ...
            if OrgName <> "" then 
                ...
                | false -> 
                    ...
                    let postAddress = ""
                    let factAddress = ""
                    let phone = tn.PersonTel
                    let email = tn.PersonEmail
                    let inn = ""
            ...
            let regionS = Tools.GetRegionString(tn.CusAddress)
            if regionS <> "" then 
            ...
            cmd16.Parameters.AddWithValue("@delivery_place", tn.CusAddress) |> ignore
