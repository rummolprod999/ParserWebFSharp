    ...
    override this.Parsing() =
        ...
        let res =
                   builder {
                        ...
                        let IdOrg = ref 0
                        let orgName = InlineHtmlNavigator nav "//td[contains(., 'Наименование организации')]/following-sibling::td"
                        ...
                        if orgName <> "" then
                            ...
                            | false ->
                                ...
                                let contactPerson = ""
                                let postAddress = InlineHtmlNavigator nav "//td[contains(., 'Почтовый адрес')]/following-sibling::td"
                                let factAddress = InlineHtmlNavigator nav "//td[contains(., 'Место нахождения')]/following-sibling::td"
                                let phone = InlineHtmlNavigator nav "//td[contains(., 'Телефон / Факс')]/following-sibling::td"
                                let inn = ""
                                let email = ""
                        ...
                        let! dateEndT = nav.GsnDocWithError "//h4[. = 'Дата начала / окончания подачи заявок']/following-sibling::span[2]" <| sprintf "dateEndT not found %s" tn.Href
