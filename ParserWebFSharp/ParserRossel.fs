...
type ParserRossel(stn: Settings.T) =
    ...
    let url =
        "https://www.roseltorg.ru/search/com"
            ...
            if !theEnd then
                try
                    ...
                    wait.Until (fun dr ->
                        dr
                            .FindElement(
                                By.XPath("//button[contains(@class, 'pagination__more-link')]")
                            )
                            .Displayed)
                    |> ignore
                    ...
                    jse.ExecuteScript("document.querySelector('button.pagination__more-link').click()", "")
                    |> ignore
    ...
    member private this.ParserSelen(driver: ChromeDriver) =
        ...
        driver
            .Navigate()
            .GoToUrl(
                "https://www.roseltorg.ru/procedures/search?sale=0&source%5B%5D=2&status%5B%5D=0&status%5B%5D=1&currency=all"
            )
        ...
        wait.Until (fun dr ->
            dr
                .FindElement(
                    By.XPath("//a[contains(@class, 'btn-advanced-search')]")
                )
                .Displayed)
        |> ignore
    ...
    member private this.ParserSelenBussines(driver: ChromeDriver) =
        ...
        driver
            .Navigate()
            .GoToUrl(
                "https://www.roseltorg.ru/procedures/search?sale=0&source%5B%5D=24&status%5B%5D=0&status%5B%5D=1&currency=all"
            )
    ...
    member private this.ParserSelenAll(driver: ChromeDriver) =
        ...
        driver
            .Navigate()
            .GoToUrl(
                "https://www.roseltorg.ru/procedures/search?sale=0&source%5B%5D=all&status%5B%5D=0&status%5B%5D=1&currency=all"
            )
    ...
    member private this.ParserSelenAtom(driver: ChromeDriver) =
        ...
        driver
            .Navigate()
            .GoToUrl(
                "https://www.roseltorg.ru/procedures/search?sale=0&source%5B%5D=3&status%5B%5D=0&status%5B%5D=1&currency=all"
            )
    ...
    member private this.ParserSelenRt(driver: ChromeDriver) =
        ...
        driver
            .Navigate()
            .GoToUrl(
                "https://www.roseltorg.ru/procedures/search?sale=0&source%5B%5D=6&status%5B%5D=0&status%5B%5D=1&currency=all"
            )
    ...
    member private this.ParserSelenVtb(driver: ChromeDriver) =
        ...
        driver
            .Navigate()
            .GoToUrl(
                "https://www.roseltorg.ru/procedures/search?sale=0&source%5B%5D=8&status%5B%5D=0&status%5B%5D=1&currency=all"
            )
    ...
    member private this.ParserSelenRosteh(driver: ChromeDriver) =
        ...
        driver
            .Navigate()
            .GoToUrl(
                "https://www.roseltorg.ru/procedures/search?sale=0&source%5B%5D=11&status%5B%5D=0&status%5B%5D=1&currency=all"
            )
    ...
    member private this.ParserSelenRushidro(driver: ChromeDriver) =
        ...
        driver
            .Navigate()
            .GoToUrl(
                "https://www.roseltorg.ru/procedures/search?sale=0&source%5B%5D=14&status%5B%5D=0&status%5B%5D=1&currency=all"
            )
    ...
    member private this.ParserSelenRosseti(driver: ChromeDriver) =
        ...
        driver
            .Navigate()
            .GoToUrl(
                "https://www.roseltorg.ru/procedures/search?sale=0&source%5B%5D=18&status%5B%5D=0&status%5B%5D=1&currency=all"
            )
    ...
    member private this.ParserSelenRosgeo(driver: ChromeDriver) =
        ...
        driver
            .Navigate()
            .GoToUrl(
                "https://www.roseltorg.ru/procedures/search?sale=0&source%5B%5D=12&status%5B%5D=0&status%5B%5D=1&currency=all"
            )
    ...
    member private this.ParserSelenKim(driver: ChromeDriver) =
        ...
        driver
            .Navigate()
            .GoToUrl(
                "https://www.roseltorg.ru/procedures/search?sale=0&source%5B%5D=21&status%5B%5D=0&status%5B%5D=1&currency=all"
            )
    ...
    member private this.ParserListTenders(driver: ChromeDriver) =
        ...
        let tenders =
            driver.FindElementsByXPath("//div[@id = 'auction_search_results']/div[@class = 'search-results__item']")
    ...
    member private this.ParserTenders (driver: ChromeDriver) (t: IWebElement) =
        //driver.SwitchTo().DefaultContent() |> ignore
        let purNumT =
            t.FindElement(By.XPath(".//a[@class = 'search-results__link']"))
    ...
    member private this.ParserSelect (_: ChromeDriver) (t: IWebElement) (purNum: string) (tFz: int) =
        ...
        let href =
            ...
            | null ->
                raise
                <| NullReferenceException(sprintf "href not found in %s" url)
            | x -> x.GetAttribute("href")

        let PurNameT =
            t.FindElement(By.XPath(".//div[@class = 'search-results__subject']/a"))
