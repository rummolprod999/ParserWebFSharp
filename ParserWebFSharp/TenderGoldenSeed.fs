                   ...
                   builder {
                        ...
                        if orgName <> "" then
                            ...
                            | false ->
                                ...
                                let contactPerson = ""
                                let postAddress = "Ростовская область, город Аксай,
улица Заречная, д. 5"
                                let factAddress = "Ростовская область, город Аксай,
улица Заречная, д. 5"
                                let phone = ""
                                let inn = ""
                                let email = "contact@grain.ru"
                        ...
                        match updated with
                        | true -> incr TenderGoldenSeed.tenderUpCount
                        | false -> incr TenderGoldenSeed.tenderCount
                        let idLot = ref 0
                        let currency = ""
                        let finSource = ""
