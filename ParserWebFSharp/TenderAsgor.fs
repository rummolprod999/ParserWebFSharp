...
type TenderAsgor(stn : Settings.T, tn : AsgorRec, typeFz : int, etpName : string, etpUrl : string) =
    ...
    override this.Parsing() =
        ...
        if reader.HasRows then reader.Close()
            ...
            cmd9.Parameters.AddWithValue("@scoring_date", tn.DateEnd) |> ignore
            ...
            match updated with
            | true -> incr TenderAsgor.tenderUpCount
            | false -> incr TenderAsgor.tenderCount
            ...
            for l in tn.NameLots do
                ...
                cmd19.Parameters.AddWithValue("@name", l) |> ignore
