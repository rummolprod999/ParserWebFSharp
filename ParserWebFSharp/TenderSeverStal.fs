                   ...
                   builder {
                        ...
                        if orgName <> "" then
                            ...
                            | false ->
                                ...
                                let contactPerson = ""
                                let postAddress = "162608, ВОЛОГОДСКАЯ ОБЛАСТЬ, ГОРОД ЧЕРЕПОВЕЦ, УЛИЦА МИРА, Д. 30"
                                let factAddress = "162608, ВОЛОГОДСКАЯ ОБЛАСТЬ, ГОРОД ЧЕРЕПОВЕЦ, УЛИЦА МИРА, Д. 30"
                                let phone = ""
                                let inn = "3528000597"
                                let email = ""
                        ...
                        match updated with
                        | true -> incr TenderSeverStal.tenderUpCount
                        | false -> incr TenderSeverStal.tenderCount
                        let idLot = ref 0
                        let currency = ""
                        let finSource = ""
