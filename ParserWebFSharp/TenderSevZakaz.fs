...
type TenderSevZakaz
    ...
    override this.Parsing() =
        ...
        |> ignore
        driver.SwitchTo().DefaultContent() |> ignore
        if driver.Url = "https://rks.sevzakaz.ru/zakupki-malogo-obema/oos-rks-001-001" then
            failwith "start page"
        ...
        if reader.HasRows then
            ...
            match updated with
            | true -> incr TenderSevZakaz.tenderUpCount
            | false -> incr TenderSevZakaz.tenderCount
