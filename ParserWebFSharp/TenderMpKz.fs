...
type TenderMpkz(stn: Settings.T, tn: MpKzRec, typeFz: int, etpName: string, etpUrl: string) =
    ...
    override this.Parsing() =
        ...
        let res =
                   builder {
                        ...
                        cmd9.Parameters.AddWithValue("@doc_publish_date", DateTime.Today) |> ignore
                        ...
                        match updated with
                        | true -> incr TenderMpkz.tenderUpCount
                        | false -> incr TenderMpkz.tenderCount
                        ...
                        cmd12.Parameters.AddWithValue("@currency", "тг") |> ignore
