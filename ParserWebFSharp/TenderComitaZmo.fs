...
type TenderComitaZmo(stn: Settings.T, tn: ComitaRec, typeFz: int, etpName: string, etpUrl: string, driver: ChromeDriver) =
    ...
    override this.Parsing() =
        ...
        if reader.HasRows then
            ...
            match updated with
            | true -> incr TenderComitaZmo.tenderUpCount
            | false -> incr TenderComitaZmo.tenderCount
