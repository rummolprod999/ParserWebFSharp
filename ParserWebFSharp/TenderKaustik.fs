...
type TenderKaustik(stn: Settings.T, tn: KaustikRec, typeFz: int, etpName: string, etpUrl: string) =
    ...
    override this.Parsing() =
        ...
        let res =
                   builder {
                        ...
                        cmd9.Parameters.AddWithValue("@notice_version", tn.NoticeVer) |> ignore
                        ...
                        match updated with
                        | true -> incr TenderKaustik.tenderUpCount
                        | false -> incr TenderKaustik.tenderCount
                        let idLot = ref 0
                        let currency = ""
                        let finSource = ""
                        ...
                        cmd5.Parameters.AddWithValue("@file_name", tn.AttachName) |> ignore
                        cmd5.Parameters.AddWithValue("@url", tn.AttachUrl) |> ignore
