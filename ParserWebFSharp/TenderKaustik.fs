    ...
    override this.Parsing() =
        ...
        let res =
            builder {
                ...
                cmd9.Parameters.AddWithValue("@notice_version", tn.NoticeVer)
                |> ignore
                ...
                cmd5.Parameters.AddWithValue("@file_name", tn.AttachName)
                |> ignore

                cmd5.Parameters.AddWithValue("@url", tn.AttachUrl)
                |> ignore
