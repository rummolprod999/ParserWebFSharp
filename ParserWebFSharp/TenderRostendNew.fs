...
type TenderRosTendNew
    ...
    override this.Parsing() =
        ...
        if reader.HasRows then
            ...
            let regionS =
                Tools.GetRegionString(tn.Region)
            ...
            cmd9.Parameters.AddWithValue("@date_version", tn.DateUpd)
            |> ignore
            ...
            match updated with
            | true -> incr TenderRosTendNew.tenderUpCount
            | false -> incr TenderRosTendNew.tenderCount
