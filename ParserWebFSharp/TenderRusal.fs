                   ...
                   builder {
                        ...
                        if orgName <> "" then
                            ...
                            | false ->
                                ...
                                let contactPerson = ""
                                let postAddress = "Россия, 121096, г. Москва ул. Василисы Кожиной, д.1"
                                let factAddress = ""
                                let phone = "+7 (495) 720-51-70; +7 (495) 720-51-71"
                                let inn = "7709329253"
                                let email = "documents@rusal.com"
                        ...
                        match updated with
                        | true -> incr TenderRusal.tenderUpCount
                        | false -> incr TenderRusal.tenderCount
