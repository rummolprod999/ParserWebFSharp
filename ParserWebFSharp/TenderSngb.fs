...
type TenderSngb(stn: Settings.T, tn: SngbRec, typeFz: int, etpName: string, etpUrl: string) =
    ...
    override this.Parsing() =
        ...
        let res =
            builder {
                ...
                match updated with
                | true -> incr TenderSngb.tenderUpCount
                | false -> incr TenderSngb.tenderCount
