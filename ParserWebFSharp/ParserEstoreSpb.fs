...
type ParserEstoreSpb(stn: Settings.T) =
    ...
    let spage =
        "https://estore.gz-spb.ru/electronicshop/catalog/procedure/index/?page="
    ...
    member private __.ParsingPage(url: string) =
        ...
        | s ->
            ...
            let tens =
                documents.QuerySelectorAll("table > tbody > tr[id ^= 'rowId']")
    ...
    member private __.ParsingTender (t: IElement) (url: string) =
        ...
        let res =
            builder {
                ...
                let href =
                    sprintf "https://estore.gz-spb.ru%s" href
                ...
                let! dateEnd =
                    dateEndT.DateFromStringDoc("HH:mm dd.MM.yyyy", sprintf "dateEnd not found %s %s " href dateEndT)
                ...
                let! datePub =
                    datePubT.DateFromStringDoc("HH:mm dd.MM.yyyy", sprintf "datePub not found %s %s " href datePubT)
                ...
                let T =
                    TenderEstoreSpb(
                        ...
                        tend,
                        230,
                        "Комитет по государственному заказу Санкт-Петербурга АИС ГЗ",
                        "https://estore.gz-spb.ru/"
                    )
