...
type TenderBelorusNeft(stn: Settings.T, tn: OsnovaRec, typeFz: int, etpName: string, etpUrl: string) =
    ...
    override this.Parsing() =
        ...
        let res =
                   builder {
                        ...
                        match updated with
                        | true -> incr TenderBelorusNeft.tenderUpCount
                        | false -> incr TenderBelorusNeft.tenderCount
                        ...
                        if tn.Href <> "" then
                            ...
                            cmd5.Parameters.AddWithValue("@file_name", "скачать файл") |> ignore
