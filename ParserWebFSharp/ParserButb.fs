    ...
    member private this.ParserTender (driver: ChromeDriver) (s: int) =
        ...
        let datePub =
            ...
            | None ->
                ...
                | None ->
                    raise
                    <| Exception(sprintf "cannot parse datePubS %s, %s" datePubS url)
        ...
        let endDate =
            ...
            | None ->
                ...
                | None ->
                    raise
                    <| Exception(sprintf "cannot parse endDateS %s, %s" endDateS url)
        ...
        try
            let T =
                TenderButb(stn, purNum, datePub, endDate, biddingDate, driver, wait, s, status)
